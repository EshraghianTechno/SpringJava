...
public class Test {
    public static void main(String[] args) {
        ...
        context.load("file:F:\\SpringJava\\session6\\src\\main\\java\\p02BeanScopes\\p02prototype\\config.xml");
        context.refresh();

        final ProductService bean1 = context.getBean("productService1", ProductService.class);
        System.out.println(bean1.getProductDao());

        final ProductService bean2 = context.getBean("productService1",ProductService.class );
